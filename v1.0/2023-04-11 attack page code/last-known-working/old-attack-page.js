...
function setFlankingVariable() {
    ...
    // set flankingBonus based on boolean
...
function setRangedWeapon() {
    console.log("ranged attack");

    setAbilityVariables();
    ResetRangedAttackModifiers();

    let valueSelected = document.getElementById("menuRangedWeapon").value;
    rangedWeapon = valueSelected;
...
function setRangedWeaponFullAutoUI() {
    document.getElementById("fireRateMenu").style.display = "block";
...
function setRangedWeaponSingleShotUI() {
    document.getElementById("fireRateMenu").style.display = "none";
    document.getElementById("rangeToTargetMenu").style.display = "block";
    document.getElementById("scopeDiv").style.display = "block";
    document.getElementById("shootButton").style.display = "block";
    document.getElementById("throwingRangeMenu").style.display = "none";
